...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">تقارير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ ملف خروج المريض</span>
						</div>
					</div>
							...
							<div class="card card-invoice">
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											<label class="tx-gray-600">ملف دخول المريض</label>
                                            ...
                                            <p class="invoice-info-row"><span>تاريخ الخروج</span> <span>{{date('Y-m-d') }}</span></p>
