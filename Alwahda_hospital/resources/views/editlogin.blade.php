...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">  تعديل ملف المريض</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
                ...
                @endif
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card">
									<div class="card-body">
										<form action="{{URL('patients/update_status')}}" method="post" enctype="multipart/form-data"
											autocomplete="off">
											{{ method_field('patch') }}
											{{ csrf_field() }}
											{{-- 1 --}}
											...
											<div class="row">
												...
												<div class="col">
													...
													<select class='form-control' name='sections_id' >
														<!--placeholder-->
														<option value=" {{ $patients->sections->id }}">
															{{ $patients->sections->name }}
														</option>
												...
												<div class="col">
													...
													<input class="form-control fc-datepicker" name="dateofentry" placeholder="YYYY-MM-DD"
														type="text" value="{{ $patients->dateofentry }}" >
												</div>
											...
											<div class="row">
												...
												<div class="col">
													...
													<input type="text" class="form-control" id="inputName" name="age" value="{{ $patients->age }}"
														title="يرجي ادخال العمر " >
												</div>
												...
												<div class="col">
													...
													<select class='form-control' name='maritalstatus' value="{{ $patients->maritalstatus }}" >
												...
												<div class="col">
													...
													<input type="text" class="form-control" id="inputName" name="job" value="{{ $patients->job }}"
														title="يرجي ادخال المهنة " >
												</div>
											</div><br>
												<div class="row">
												...
												<div class="col">
													...
													<input type="text" class="form-control" id="inputName" name="phone" value="{{ $patients->phone }}"
														title="يرجي ادخال رقم الهاتف" >
												</div>

												<div class="col">
													<label for="inputName" class="control-label">    عنوان السكن </label>
													<input type="text" class="form-control" id="inputName" name="address" value="{{ $patients->address }}"
														title="يرجي ادخال  عنوان السكن" >
												</div>

												<div class="col">
													<label for="inputName" class="control-label">    اقرب الأقارب وعنوانه</label>
													<input type="text" class="form-control" id="inputName" name="family" value="{{ $patients->family }}"
														title="يرجي ادخال بيانات الاقارب " >
												</div>

												<div class="col">
													<label for="inputName" class="control-label">     رقم البطاقة الشخصية   </label>
													<input type="text" class="form-control" id="inputName" name="idcard" value="{{ $patients->idcard }}"
														title="يرجي ادخال رقم البطاقة الشخصية" >
												</div>
												...
												<div class="col">
													...
													<textarea class="form-control" id="exampleTextarea" name="note" rows="3" value="{{ $patients->note }}"></textarea>
												</div>
												<br>
										<div class="col">
